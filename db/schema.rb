...
ActiveRecord::Schema.define(version: 20_150_927_194_220) do
  ...
  add_index 'memberships', %w(user_id building_id), name: 'index_memberships_on_user_id_and_building_id', unique: true, using: :btree
