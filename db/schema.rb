...
ActiveRecord::Schema.define(version: 20_160_120_163_930) do
  ...
  add_index 'activities', %w(actionable_type actionable_id), name: 'index_activities_on_actionable_type_and_actionable_id', using: :btree
  ...
  add_index 'memberships', %w(membership_type building_id user_id), name: 'user_building_membership', unique: true, using: :btree
  add_index 'memberships', %w(user_id building_id membership_type), name: 'user_buidling_membership', unique: true, using: :btree
  ...
  add_index 'messages', %w(building_id recipient_id), name: 'index_messages_on_building_id_and_recipient_id', using: :btree
  add_index 'messages', %w(building_id sender_id), name: 'index_messages_on_building_id_and_sender_id', using: :btree
  ...
  add_index 'notifications', %w(notifiable_type notifiable_id), name: 'index_notifications_on_notifiable_type_and_notifiable_id', using: :btree
  ...
  add_index 'posts', %w(postable_type postable_id), name: 'index_posts_on_postable_type_and_postable_id', using: :btree
  ...
  add_index 'tickets', %w(building_id severity), name: 'index_tickets_on_building_id_and_severity', using: :btree
  add_index 'tickets', %w(building_id status), name: 'index_tickets_on_building_id_and_status', using: :btree
